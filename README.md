# GOST1k - Поисково-дополненная генерация по нормативам (Hybrid RAG)
Локальный бот-ассистент для контроля соответствия ГОСТ, РД, ISO, ФСТЭК/ФСБ, СТО БР ИБ и другим НПА.
