#  G🔍ST1k — локальный RAG для регуляторных документов и стандартов
...
Система построена на принципах hybrid retrieval (dense + sparse + lexical) - RTT fusion - reranking, offline on-prem архитектуру.
