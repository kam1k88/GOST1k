🔍 GOST1k — локальный RAG по регуляторным документам
...
Рассчитана на максимальную точность и достоверность извлекаемой информации, без генерации данных, отсутствующих в источниках.
---
